  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <AnimatedCard index={0}>
              <GlassBlogCard
                ...
                author={{ name: "Maël B.", avatar: "https://github.com/shadcn.png" }}
                date="2026"
                readTime="C, STM32, FreeRTOS, HAL"
      ...
      <section id="contact" className="w-full px-4 md:px-6 py-24 md:py-32">
        <AnimatedSection className="max-w-6xl mx-auto">
          <SectionTitle id="03" title="Contact" />
          <ContactBento />
        </AnimatedSection>
      </section>
      <Footer
