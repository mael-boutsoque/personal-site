...
export function Component({
  ...
  useEffect(() => {
    ...
    const onScroll = () => {
      ...
      const triggerAt = windowHeight * 0.6
      const range = 300
      const scrolled = triggerAt - rect.top
  ...
  return (
    <div ref={cardRef} className={cn("space-y-4", className)}>
      {/* Layout Toggle */}
      <div className="flex items-center justify-center gap-1 rounded-lg bg-white p-1 w-fit mx-auto">
        {(Object.keys(layoutIcons) as ("stack" | "list")[]).map((mode) => {
